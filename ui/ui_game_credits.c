...
void M_Credits_MenuDraw( void )
{
	...
	Menu_DrawString(scaledHud(130), scaledHud(57), "^0blendogames.com", 255);
	...
	Menu_DrawString(scaledHud(130), scaledHud(85), "^0lazarus.planetquake.gamespy.com", 255);

	Menu_DrawString(scaledHud(30), scaledHud(92), "^0Knightmare", 255);
	Menu_DrawString(scaledHud(130), scaledHud(92), "^0kmq2.quakedev.com", 255);

	Menu_DrawString(scaledHud(30), scaledHud(99), "^0id Software", 255);
	Menu_DrawString(scaledHud(130), scaledHud(99), "^0idsoftware.com", 255);
